...
import numpy as np
import os
from CW3.BreedInfo import * 


basedir = os.path.abspath(os.path.dirname(__file__))
app.config['ALLOWED_EXTENSIONS'] = set(['png', 'jpg', 'jpeg'])
app.config['JSON_SORT_KEYS'] = False
model_file = basedir + '/model/catbreed_model.h5'
upload_dir = "upload"
...
def breed_predict(image_name):
    ...
    upload_image = basedir + "/upload/" + image_name
    image = cv2.resize(cv2.imread(upload_image), (224, 224))
